                    ...
                    @foreach($products as $product)
                        ...
                        <div class="col-md-4 product-left p-left">
                            <div class="product-main simpleCart_shelfItem">
                                <a href="{{ route('blog.admin.products.edit',$product->id)}}" target="_blank" class="mask">
                                ...
                                <div class="product-bottom">
                                    <a href="{{ route('blog.admin.products.edit',$product->id)}}" target="_blank" class="mask"><h3>{{$product->title}}</h3></a>
                                    <p>Explore Now</p>
                                    <h4>
